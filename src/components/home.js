...
class Home extends Component {
  ...
  constructor(props){
    ...
    axios.post('http://10.90.90.110:3002/').then(res=>{
  ...
  render() {
    ...
    const stories = this.state.stories.slice(6,9).map((d) => 
            ...
            <Row style={rowStyle}>
              <Col sm="4">
                <img src="mountain.jpg" height="100px" width="100px" alt="poster"/>
              </Col>
    ...
    <Container>
        <Row>
          ...
          <Col sm="4">
            <Card>
              <CardImg top width="100%" src="mountain.jpg" alt="Card image cap" />
              <CardBody>
